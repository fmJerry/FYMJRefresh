...
const CGFloat MJRefreshLabelLeftInset = 0;//ALORSFAN：loading动画位置偏移量修改
...
NSString *const MJRefreshAutoFooterIdleText = @"";//ALORSFAN：去掉文字
NSString *const MJRefreshAutoFooterRefreshingText = @"";//ALORSFAN：去掉文字
